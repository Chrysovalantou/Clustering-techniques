##### File including All Methods for Principal Component Analysis
...
def PCA(Arr,y,M):
	...
	for i in range(X.shape[1]):
	    ...
	    #Scatter_Matrix += (X[:,i].reshape(D,1) - mean_vector).dot((X[:,i].reshape(D,1) - mean_vector).T) 
	...
	# Sort the (eigenvalue, eigenvector) tuples from high to low __ Using lambda function :) 
...
def KERNEL(Arr,y,M):
	...
	kernel = input("Construct the Kernel Matrix:\n Press G for Gaussian, P for Polynomial and T for Tanget: ")
